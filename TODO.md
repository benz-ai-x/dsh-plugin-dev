...
- [ ] Recheck npm availability for every pinned DSH runtime and peer dependency.
...
- [ ] Define the audited-baseline upgrade workflow and generated-project migration guidance.
...
Current status: met for the deterministic Tool vertical slice in both Codex and Claude Code. P3's packaged-marketplace smoke remains follow-up work, as do the additional project kinds in P4.
